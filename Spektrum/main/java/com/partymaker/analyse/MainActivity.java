package com.partymaker.analyse;
...
import com.partymaker.analyse.utils.AnalyzerProcessingLoop;
import com.partymaker.analyse.utils.Demodulator;
import com.partymaker.analyse.utils.FileIQSource;
import com.partymaker.analyse.utils.FileUtils;
import com.partymaker.analyse.utils.IQSourceInterface;
import com.partymaker.analyse.utils.RFControlInterface;
import com.partymaker.analyse.utils.RtlsdrSource;
import com.partymaker.analyse.utils.Scheduler;
...
public class MainActivity extends AppCompatActivity implements IQSourceInterface.Callback, RFControlInterface {
    ...
    private static final int FILESOURCE_RESULT_CODE = 7;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.partymaker.analyse.R.layout.activity_main);
        askForPhoneStatePermission();
        this.savedInstanceState = savedInstanceState;

        // Set default Settings on first run:
        PreferenceManager.setDefaultValues(this, com.partymaker.analyse.R.xml.preferences, false);
        ...
        if (preferences.getString(getString(com.partymaker.analyse.R.string.pref_filesource_file), "").equals(defaultFile))
            preferences.edit().putString(getString(com.partymaker.analyse.R.string.pref_filesource_file), extStorage + "/" + defaultFile).apply();
        // Log file:
        defaultFile = getString(com.partymaker.analyse.R.string.pref_logfile_default);
        if (preferences.getString(getString(com.partymaker.analyse.R.string.pref_logfile), "").equals(defaultFile))
            preferences.edit().putString(getString(com.partymaker.analyse.R.string.pref_logfile), extStorage + "/" + defaultFile).apply();

        // Start logging if enabled:
        if (preferences.getBoolean(getString(com.partymaker.analyse.R.string.pref_logging), false)) {
            if (ContextCompat.checkSelfPermission(this, "android.permission.WRITE_EXTERNAL_STORAGE")
                    == PackageManager.PERMISSION_GRANTED) {
                try {
                    File logfile = new File(preferences.getString(getString(com.partymaker.analyse.R.string.pref_logfile), ""));
                ...
                preferences.edit().putBoolean(getString(com.partymaker.analyse.R.string.pref_logging), false).apply();
        ...
        fl_analyzerFrame = (FrameLayout) findViewById(com.partymaker.analyse.R.id.fl_analyzerFrame);

        // Create a analyzer surface:
        analyzerSurface = new AnalyzerSurface(this, this);
        analyzerSurface.setVerticalScrollEnabled(preferences.getBoolean(getString(com.partymaker.analyse.R.string.pref_scrollDB), true));
        analyzerSurface.setVerticalZoomEnabled(preferences.getBoolean(getString(com.partymaker.analyse.R.string.pref_zoomDB), true));
        analyzerSurface.setDecoupledAxis(preferences.getBoolean(getString(com.partymaker.analyse.R.string.pref_decoupledAxis), false));
        analyzerSurface.setDisplayRelativeFrequencies(preferences.getBoolean(getString(com.partymaker.analyse.R.string.pref_relativeFrequencies), false));
        analyzerSurface.setWaterfallColorMapType(Integer.valueOf(preferences.getString(getString(com.partymaker.analyse.R.string.pref_colorMapType), "4")));
        analyzerSurface.setFftDrawingType(Integer.valueOf(preferences.getString(getString(com.partymaker.analyse.R.string.pref_fftDrawingType), "2")));
        analyzerSurface.setFftRatio(Float.valueOf(preferences.getString(getString(com.partymaker.analyse.R.string.pref_spectrumWaterfallRatio), "0.5")));
        analyzerSurface.setFontSize(Integer.valueOf(preferences.getString(getString(com.partymaker.analyse.R.string.pref_fontSize), "2")));
        analyzerSurface.setShowDebugInformation(preferences.getBoolean(getString(com.partymaker.analyse.R.string.pref_showDebugInformation), false));
        ...
        if (savedInstanceState != null) {
            running = savedInstanceState.getBoolean(getString(com.partymaker.analyse.R.string.save_state_running));
            demodulationMode = savedInstanceState.getInt(getString(com.partymaker.analyse.R.string.save_state_demodulatorMode));
			 ...
			 */
            if (running && Integer.valueOf(preferences.getString(getString(com.partymaker.analyse.R.string.pref_sourceType), "1")) == RTLSDR_SOURCE
                    && !preferences.getBoolean(getString(com.partymaker.analyse.R.string.pref_rtlsdr_externalServer), false)) {
            ...
            running = preferences.getBoolean((getString(com.partymaker.analyse.R.string.pref_autostart)), false);
        }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        outState.putBoolean(getString(com.partymaker.analyse.R.string.save_state_running), running);
        outState.putInt(getString(com.partymaker.analyse.R.string.save_state_demodulatorMode), demodulationMode);
        if (analyzerSurface != null) {
            outState.putLong(getString(com.partymaker.analyse.R.string.save_state_channelFrequency), analyzerSurface.getChannelFrequency());
            outState.putInt(getString(com.partymaker.analyse.R.string.save_state_channelWidth), analyzerSurface.getChannelWidth());
            outState.putFloat(getString(com.partymaker.analyse.R.string.save_state_squelch), analyzerSurface.getSquelch());
            outState.putLong(getString(com.partymaker.analyse.R.string.save_state_virtualFrequency), analyzerSurface.getVirtualFrequency());
            outState.putInt(getString(com.partymaker.analyse.R.string.save_state_virtualSampleRate), analyzerSurface.getVirtualSampleRate());
            outState.putFloat(getString(com.partymaker.analyse.R.string.save_state_minDB), analyzerSurface.getMinDB());
            outState.putFloat(getString(com.partymaker.analyse.R.string.save_state_maxDB), analyzerSurface.getMaxDB());
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(com.partymaker.analyse.R.menu.main2, menu);
        // Get a reference to the start-stop button:
        mi_startStop = menu.findItem(com.partymaker.analyse.R.id.action_startStop);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case com.partymaker.analyse.R.id.action_startStop:
                if (running)
                    stopAnalyzer();
                else
                    startAnalyzer();
                break;
            case com.partymaker.analyse.R.id.select:
                selectFile();
                break;
            default:
        }
        ...
        this.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (mi_startStop != null) {
                    if (running) {
                        mi_startStop.setTitle(com.partymaker.analyse.R.string.action_stop);
                        mi_startStop.setIcon(com.partymaker.analyse.R.drawable.ic_action_pause);
                    } else {
                        mi_startStop.setTitle(com.partymaker.analyse.R.string.action_start);
                        mi_startStop.setIcon(com.partymaker.analyse.R.drawable.ic_action_play);
                    }
                }
                ...
                if (mi_demodulationMode != null) {
                    ...
                    switch (demodulationMode) {
                        case Demodulator.DEMODULATION_OFF:
                            iconRes = com.partymaker.analyse.R.drawable.ic_action_demod_off;
                            titleRes = com.partymaker.analyse.R.string.action_demodulation_off;
                            break;
                        case Demodulator.DEMODULATION_AM:
                            iconRes = com.partymaker.analyse.R.drawable.ic_action_demod_am;
                            titleRes = com.partymaker.analyse.R.string.action_demodulation_am;
                            break;
                        case Demodulator.DEMODULATION_NFM:
                            iconRes = com.partymaker.analyse.R.drawable.ic_action_demod_nfm;
                            titleRes = com.partymaker.analyse.R.string.action_demodulation_nfm;
                            break;
                        case Demodulator.DEMODULATION_WFM:
                            iconRes = com.partymaker.analyse.R.drawable.ic_action_demod_wfm;
                            titleRes = com.partymaker.analyse.R.string.action_demodulation_wfm;
                            break;
                        case Demodulator.DEMODULATION_LSB:
                            iconRes = com.partymaker.analyse.R.drawable.ic_action_demod_lsb;
                            titleRes = com.partymaker.analyse.R.string.action_demodulation_lsb;
                            break;
                        case Demodulator.DEMODULATION_USB:
                            iconRes = com.partymaker.analyse.R.drawable.ic_action_demod_usb;
                            titleRes = com.partymaker.analyse.R.string.action_demodulation_usb;
                            break;
                        default:
                ...
                if (mi_record != null) {
                    if (recordingFile != null) {
                        mi_record.setTitle(com.partymaker.analyse.R.string.action_recordOn);
                        mi_record.setIcon(com.partymaker.analyse.R.drawable.ic_action_record_on);
                    } else {
                        mi_record.setTitle(com.partymaker.analyse.R.string.action_recordOff);
                        mi_record.setIcon(com.partymaker.analyse.R.drawable.ic_action_record_off);
                    }
                }
            }
        });
    ...
    protected void onStart() {
        ...
        if (savedInstanceState != null) {
            analyzerSurface.setVirtualFrequency(savedInstanceState.getLong(getString(com.partymaker.analyse.R.string.save_state_virtualFrequency)));
            analyzerSurface.setVirtualSampleRate(savedInstanceState.getInt(getString(com.partymaker.analyse.R.string.save_state_virtualSampleRate)));
            analyzerSurface.setDBScale(savedInstanceState.getFloat(getString(com.partymaker.analyse.R.string.save_state_minDB)),
                    savedInstanceState.getFloat(getString(com.partymaker.analyse.R.string.save_state_maxDB)));
            analyzerSurface.setChannelFrequency(savedInstanceState.getLong(getString(com.partymaker.analyse.R.string.save_state_channelFrequency)));
            analyzerSurface.setChannelWidth(savedInstanceState.getInt(getString(com.partymaker.analyse.R.string.save_state_channelWidth)));
            analyzerSurface.setSquelch(savedInstanceState.getFloat(getString(com.partymaker.analyse.R.string.save_state_squelch)));
            if (demodulator != null && scheduler != null) {
                demodulator.setChannelWidth(savedInstanceState.getInt(getString(com.partymaker.analyse.R.string.save_state_channelWidth)));
                scheduler.setChannelFrequency(savedInstanceState.getLong(getString(com.partymaker.analyse.R.string.save_state_channelFrequency)));
            }
    ...
    protected void onStop() {
        ...
        if (source != null) {
            ...
            edit.putLong(getString(com.partymaker.analyse.R.string.pref_frequency), source.getFrequency());
            edit.putInt(getString(com.partymaker.analyse.R.string.pref_sampleRate), source.getSampleRate());
            edit.commit();
        }
    }
        ...
        switch (requestCode) {
            ...
            case FILESOURCE_RESULT_CODE:
                ...
                if (uri != null) {
                    ...
                    if (filepath != null) {
                        preferences.edit().putString(getString(com.partymaker.analyse.R.string.pref_filesource_file), filepath).apply();
                    } else {
                        Toast.makeText(this, "Can't resolve file path from: " + uri.toString(), Toast.LENGTH_LONG).show();
                    }
                }
                break;
            default:
    ...
    public void checkForChangedPreferences() {
        ...
        int sourceType = Integer.valueOf(preferences.getString(getString(com.partymaker.analyse.R.string.pref_sourceType), "1"));
        if (source != null) {
            switch (sourceType) {
                case FILE_SOURCE:
                    if (!(source instanceof FileIQSource)) {
                        ...
                        long freq = Integer.valueOf(preferences.getString(getString(com.partymaker.analyse.R.string.pref_filesource_frequency), "97000000"));
                        int sampRate = Integer.valueOf(preferences.getString(getString(com.partymaker.analyse.R.string.pref_filesource_sampleRate), "2000000"));
                        String fileName = preferences.getString(getString(com.partymaker.analyse.R.string.pref_filesource_file), "");
                        int fileFormat = Integer.valueOf(preferences.getString(getString(com.partymaker.analyse.R.string.pref_filesource_format), "0"));
                        boolean repeat = preferences.getBoolean(getString(com.partymaker.analyse.R.string.pref_filesource_repeat), false);
                ...
                case RTLSDR_SOURCE:
                    if (!(source instanceof RtlsdrSource)) {
                        ...
                        String ip = preferences.getString(getString(com.partymaker.analyse.R.string.pref_rtlsdr_ip), "");
                        int port = Integer.valueOf(preferences.getString(getString(com.partymaker.analyse.R.string.pref_rtlsdr_port), "1234"));
                        boolean externalServer = preferences.getBoolean(getString(com.partymaker.analyse.R.string.pref_rtlsdr_externalServer), false);
                        if (externalServer) {
                        ...
                        int frequencyCorrection = Integer.valueOf(preferences.getString(getString(com.partymaker.analyse.R.string.pref_rtlsdr_frequencyCorrection), "0"));
                        int frequencyOffset = Integer.valueOf(preferences.getString(getString(com.partymaker.analyse.R.string.pref_rtlsdr_frequencyOffset), "0"));
        ...
        if (analyzerSurface != null) {
            ...
            analyzerSurface.setWaterfallColorMapType(Integer.valueOf(preferences.getString(getString(com.partymaker.analyse.R.string.pref_colorMapType), "4")));
            analyzerSurface.setFftDrawingType(Integer.valueOf(preferences.getString(getString(com.partymaker.analyse.R.string.pref_fftDrawingType), "2")));
            analyzerSurface.setAverageLength(Integer.valueOf(preferences.getString(getString(com.partymaker.analyse.R.string.pref_averaging), "0")));
            analyzerSurface.setPeakHoldEnabled(preferences.getBoolean(getString(com.partymaker.analyse.R.string.pref_peakHold), false));
            analyzerSurface.setFftRatio(Float.valueOf(preferences.getString(getString(com.partymaker.analyse.R.string.pref_spectrumWaterfallRatio), "0.5")));
            analyzerSurface.setFontSize(Integer.valueOf(preferences.getString(getString(com.partymaker.analyse.R.string.pref_fontSize), "2")));
            analyzerSurface.setShowDebugInformation(preferences.getBoolean(getString(com.partymaker.analyse.R.string.pref_showDebugInformation), false));
        }
        ...
        // Screen Orientation:
        String screenOrientation = preferences.getString(getString(com.partymaker.analyse.R.string.pref_screenOrientation), "auto");
    ...
    public boolean createSource() {
        ...
        switch (sourceType) {
            case FILE_SOURCE:
                ...
                try {
                    frequency = Integer.valueOf(preferences.getString(getString(com.partymaker.analyse.R.string.pref_filesource_frequency), "97000000"));
                    sampleRate = Integer.valueOf(preferences.getString(getString(com.partymaker.analyse.R.string.pref_filesource_sampleRate), "2000000"));
            ...
            case RTLSDR_SOURCE:
                // Create RtlsdrSource
                if (preferences.getBoolean(getString(com.partymaker.analyse.R.string.pref_rtlsdr_externalServer), false))
                    source = new RtlsdrSource(preferences.getString(getString(com.partymaker.analyse.R.string.pref_rtlsdr_ip), ""),
                            Integer.valueOf(preferences.getString(getString(com.partymaker.analyse.R.string.pref_rtlsdr_port), "1234")));
                else {
                    source = new RtlsdrSource("127.0.0.1", 1234);
                }

                frequency = preferences.getLong(getString(com.partymaker.analyse.R.string.pref_frequency), 97000000);
                sampleRate = preferences.getInt(getString(com.partymaker.analyse.R.string.pref_sampleRate), source.getMaxSampleRate());
                if (sampleRate > 2000000)    // might be the case after switching over from HackRF
                    sampleRate = 2000000;
                source.setFrequency(frequency);
                source.setSampleRate(sampleRate);

                ((RtlsdrSource) source).setFrequencyCorrection(Integer.valueOf(preferences.getString(getString(com.partymaker.analyse.R.string.pref_rtlsdr_frequencyCorrection), "0")));
                ((RtlsdrSource) source).setFrequencyOffset(Integer.valueOf(
                        preferences.getString(getString(com.partymaker.analyse.R.string.pref_rtlsdr_frequencyOffset), "0")));
                ((RtlsdrSource) source).setManualGain(preferences.getBoolean(getString(com.partymaker.analyse.R.string.pref_rtlsdr_manual_gain), false));
                ((RtlsdrSource) source).setAutomaticGainControl(preferences.getBoolean(getString(com.partymaker.analyse.R.string.pref_rtlsdr_agc), false));
                if (((RtlsdrSource) source).isManualGain()) {
                    ((RtlsdrSource) source).setGain(preferences.getInt(getString(com.partymaker.analyse.R.string.pref_rtlsdr_gain), 0));
                    ((RtlsdrSource) source).setIFGain(preferences.getInt(getString(com.partymaker.analyse.R.string.pref_rtlsdr_ifGain), 0));
                }
                break;
            default:
    ...
    public void startAnalyzer() {
        ...
        int fftSize = Integer.valueOf(preferences.getString(getString(com.partymaker.analyse.R.string.pref_fftSize), "1024"));
        int frameRate = Integer.valueOf(preferences.getString(getString(com.partymaker.analyse.R.string.pref_frameRate), "1"));
        boolean dynamicFrameRate = preferences.getBoolean(getString(com.partymaker.analyse.R.string.pref_dynamicFrameRate), true);
    ...
    private void showDemodulationDialog() {
        ...
        new AlertDialog.Builder(this)
                ...
                .setSingleChoiceItems(com.partymaker.analyse.R.array.demodulation_modes, demodulator.getDemodulationMode(), new DialogInterface.OnClickListener() {
    ...
    private void tuneToFrequency() {
        ...
        final LinearLayout ll_view = (LinearLayout) this.getLayoutInflater().inflate(com.partymaker.analyse.R.layout.tune_to_frequency, null);
        final EditText et_frequency = (EditText) ll_view.findViewById(com.partymaker.analyse.R.id.et_tune_to_frequency);
        final Spinner sp_unit = (Spinner) ll_view.findViewById(com.partymaker.analyse.R.id.sp_tune_to_frequency_unit);
        final CheckBox cb_bandwidth = (CheckBox) ll_view.findViewById(com.partymaker.analyse.R.id.cb_tune_to_frequency_bandwidth);
        final EditText et_bandwidth = (EditText) ll_view.findViewById(com.partymaker.analyse.R.id.et_tune_to_frequency_bandwidth);
        final Spinner sp_bandwidthUnit = (Spinner) ll_view.findViewById(com.partymaker.analyse.R.id.sp_tune_to_frequency_bandwidth_unit);
        final TextView tv_warning = (TextView) ll_view.findViewById(com.partymaker.analyse.R.id.tv_tune_to_frequency_warning);
        ...
        cb_bandwidth.setChecked(preferences.getBoolean(getString(com.partymaker.analyse.R.string.pref_tune_to_frequency_setBandwidth), false));
        et_bandwidth.setText(preferences.getString(getString(com.partymaker.analyse.R.string.pref_tune_to_frequency_bandwidth), "1"));
        sp_unit.setSelection(preferences.getInt(getString(com.partymaker.analyse.R.string.pref_tune_to_frequency_unit), 0));
        sp_bandwidthUnit.setSelection(preferences.getInt(getString(com.partymaker.analyse.R.string.pref_tune_to_frequency_bandwidthUnit), 0));
                    ...
                    public void onClick(DialogInterface dialog, int whichButton) {
                        try {
                            ...
                            if (newFreq <= source.getMaxFrequency() && newFreq >= source.getMinFrequency()) {
                                ...
                                // safe preferences:
                                SharedPreferences.Editor edit = preferences.edit();
                                edit.putInt(getString(com.partymaker.analyse.R.string.pref_tune_to_frequency_unit), sp_unit.getSelectedItemPosition());
                                edit.putBoolean(getString(com.partymaker.analyse.R.string.pref_tune_to_frequency_setBandwidth), cb_bandwidth.isChecked());
                                edit.putString(getString(com.partymaker.analyse.R.string.pref_tune_to_frequency_bandwidth), et_bandwidth.getText().toString());
                                edit.putInt(getString(com.partymaker.analyse.R.string.pref_tune_to_frequency_bandwidthUnit), sp_bandwidthUnit.getSelectedItemPosition());
                                edit.apply();
    ...
    private void adjustGain() {
        ...
        switch (sourceType) {
            case FILE_SOURCE:
                Toast.makeText(this, getString(com.partymaker.analyse.R.string.filesource_doesnt_support_gain), Toast.LENGTH_LONG).show();
                break;
            case RTLSDR_SOURCE:
                ...
                // Prepare layout:
                final LinearLayout view_rtlsdr = (LinearLayout) this.getLayoutInflater().inflate(com.partymaker.analyse.R.layout.rtlsdr_gain, null);
                final LinearLayout ll_rtlsdr_gain = (LinearLayout) view_rtlsdr.findViewById(com.partymaker.analyse.R.id.ll_rtlsdr_gain);
                final LinearLayout ll_rtlsdr_ifgain = (LinearLayout) view_rtlsdr.findViewById(com.partymaker.analyse.R.id.ll_rtlsdr_ifgain);
                final Switch sw_rtlsdr_manual_gain = (Switch) view_rtlsdr.findViewById(com.partymaker.analyse.R.id.sw_rtlsdr_manual_gain);
                final CheckBox cb_rtlsdr_agc = (CheckBox) view_rtlsdr.findViewById(com.partymaker.analyse.R.id.cb_rtlsdr_agc);
                final SeekBar sb_rtlsdr_gain = (SeekBar) view_rtlsdr.findViewById(com.partymaker.analyse.R.id.sb_rtlsdr_gain);
                final SeekBar sb_rtlsdr_ifGain = (SeekBar) view_rtlsdr.findViewById(com.partymaker.analyse.R.id.sb_rtlsdr_ifgain);
                final TextView tv_rtlsdr_gain = (TextView) view_rtlsdr.findViewById(com.partymaker.analyse.R.id.tv_rtlsdr_gain);
                final TextView tv_rtlsdr_ifGain = (TextView) view_rtlsdr.findViewById(com.partymaker.analyse.R.id.tv_rtlsdr_ifgain);
                ...
                AlertDialog rtlsdrDialog = new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("Set", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int whichButton) {
                                // safe preferences:
                                SharedPreferences.Editor edit = preferences.edit();
                                edit.putBoolean(getString(com.partymaker.analyse.R.string.pref_rtlsdr_manual_gain), sw_rtlsdr_manual_gain.isChecked());
                                edit.putBoolean(getString(com.partymaker.analyse.R.string.pref_rtlsdr_agc), cb_rtlsdr_agc.isChecked());
                                edit.putInt(getString(com.partymaker.analyse.R.string.pref_rtlsdr_gain), possibleGainValues[sb_rtlsdr_gain.getProgress()]);
                                edit.putInt(getString(com.partymaker.analyse.R.string.pref_rtlsdr_ifGain), possibleIFGainValues[sb_rtlsdr_ifGain.getProgress()]);
                                edit.apply();
                            }
                        })
                        .setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                ...
                rtlsdrDialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
                    ...
                    public void onDismiss(DialogInterface dialog) {
                        boolean manualGain = preferences.getBoolean(getString(com.partymaker.analyse.R.string.pref_rtlsdr_manual_gain), false);
                        boolean agc = preferences.getBoolean(getString(com.partymaker.analyse.R.string.pref_rtlsdr_agc), false);
                        int gain = preferences.getInt(getString(com.partymaker.analyse.R.string.pref_rtlsdr_gain), 0);
                        int ifGain = preferences.getInt(getString(com.partymaker.analyse.R.string.pref_rtlsdr_ifGain), 0);
    ...
    public void showRecordingDialog() {
        ...
        final int sourceType = Integer.valueOf(preferences.getString(getString(com.partymaker.analyse.R.string.pref_sourceType), "1"));
        final SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd-HH-mm-ss", Locale.US);

        // Get references to the GUI components:
        final ScrollView view = (ScrollView) this.getLayoutInflater().inflate(com.partymaker.analyse.R.layout.start_recording, null);
        final EditText et_filename = (EditText) view.findViewById(com.partymaker.analyse.R.id.et_recording_filename);
        final EditText et_frequency = (EditText) view.findViewById(com.partymaker.analyse.R.id.et_recording_frequency);
        final Spinner sp_sampleRate = (Spinner) view.findViewById(com.partymaker.analyse.R.id.sp_recording_sampleRate);
        final TextView tv_fixedSampleRateHint = (TextView) view.findViewById(com.partymaker.analyse.R.id.tv_recording_fixedSampleRateHint);
        final CheckBox cb_stopAfter = (CheckBox) view.findViewById(com.partymaker.analyse.R.id.cb_recording_stopAfter);
        final EditText et_stopAfter = (EditText) view.findViewById(com.partymaker.analyse.R.id.et_recording_stopAfter);
        final Spinner sp_stopAfter = (Spinner) view.findViewById(com.partymaker.analyse.R.id.sp_recording_stopAfter);
        ...
        int lastSampleRate = preferences.getInt(getString(com.partymaker.analyse.R.string.pref_recordingSampleRate), 1000000);
        ...
        cb_stopAfter.setChecked(preferences.getBoolean(getString(com.partymaker.analyse.R.string.pref_recordingStopAfterEnabled), false));
        et_stopAfter.setText("" + preferences.getInt(getString(com.partymaker.analyse.R.string.pref_recordingStopAfterValue), 10));
        sp_stopAfter.setSelection(preferences.getInt(getString(com.partymaker.analyse.R.string.pref_recordingStopAfterUnit), 0));
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Record", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        // safe preferences:
                        SharedPreferences.Editor edit = preferences.edit();
                        edit.putInt(getString(com.partymaker.analyse.R.string.pref_recordingSampleRate), (Integer) sp_sampleRate.getSelectedItem());
                        edit.putBoolean(getString(com.partymaker.analyse.R.string.pref_recordingStopAfterEnabled), cb_stopAfter.isChecked());
                        edit.putInt(getString(com.partymaker.analyse.R.string.pref_recordingStopAfterValue), stopAfterValue);
                        edit.putInt(getString(com.partymaker.analyse.R.string.pref_recordingStopAfterUnit), stopAfterUnit);
                        edit.apply();
    ...
    public void showInfoDialog() {
        AlertDialog dialog = new AlertDialog.Builder(this)
                .setTitle(Html.fromHtml(getString(com.partymaker.analyse.R.string.info_title, versionName)))
                .setMessage(Html.fromHtml(getString(com.partymaker.analyse.R.string.info_msg_body)))
